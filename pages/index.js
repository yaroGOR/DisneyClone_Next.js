...
export const getStaticProps = async () => {
  ...
  `
    ...
    query {
    account(where: { id: "cldvkov3j11gn0avzkp8lg9uj"}) {
      username
      avatar {
        url
      }
                ...
                <div className="video-feed">
                    <Link href="#disney">
                        <div className="franchise" id="disney">
                            <Image src={disneyLogo} width={200} height={'auto'}/>
                        </div>
                    </Link>
                    <Link href="#pixar">
                        <div className="franchise" id="pixar">
                            <Image src={pixarLogo} width={200} height={'auto'}/>
                        </div>
                    </Link>
                    <Link href="#star-wars">
                        <div className="franchise" id="star-wars">
                            <Image src={starwarsLogo} width={200} height={'auto'}/>
                        </div>
                    </Link>
                    <Link href="#nat-geo">
                        <div className="franchise" id="nat-geo">
                            <Image src={natgeoLogo} width={200} height={'auto'}/>
                        </div>
                    </Link>
                    <Link href="#marvel">
                        <div className="franchise" id="marvel">
                            <Image src={marvelLogo} width={200} height={'auto'}/>
                        </div>
                    </Link>
                </div>
